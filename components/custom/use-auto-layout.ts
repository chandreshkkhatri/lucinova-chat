...
import { useReactFlow, useNodesInitialized, Node, Edge, Position } from "@xyflow/react";
...
const getLayoutedElements = (nodes: Node[], edges: Edge[], direction: Direction = "TB") => {
...
export function useAutoLayout(direction: Direction = "TB") {
    ...
    }, [nodesInitialized, getNodes, getEdges, setNodes, setEdges, fitView, direction]);
}
